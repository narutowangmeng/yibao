...
import {
  Scan, ArrowLeft, Search, CheckCircle, Upload, FileText
} from 'lucide-react';
...
export default function IdCardChange({ onBack }: { onBack: () => void }) {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-800">身份证变更</h1>
            <p className="text-sm text-gray-500">参保人员身份证号更正</p>
          </div>
        </div>
      </div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              <div className="space-y-6">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">新身份证号</label>
                  <input
                    type="text"
                    value={newIdCard}
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 border border-gray-200 rounded-xl">
                    <option>身份证升位（15位升18位）</option>
                    <option>身份证重号变更</option>
                    <option>户籍迁移变更</option>
                    <option>录入错误更正</option>
                    <option>其他原因</option>
                  </select>
                </div>
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-amber-400 transition-colors cursor-pointer">
                    ...
                    <p className="text-gray-600">上传新旧身份证复印件、公安机关证明等</p>
                  </div>
                </div>
              </div>
            </div>
