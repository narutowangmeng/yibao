...
const initialRecords: RecordItem[] = [
  ...
  },
  {
    ...
    basic: {
      ...
      phone: '13861120019',
      householdAddress: '常州市天宁区延陵中路188号',
      residenceAddress: '常州市钟楼区劳动西路66号',
      agency: '常州',
      householdType: '城镇户籍',
      community: '兰陵街道工人新村社区',
    },
    extra: {
      subsidyType: '普通居民',
      familyRelation: '户主',
  ...
  },
  {
    ...
    category: 'flexible',
    name: '李书涵',
    idCard: '320500199305246827',
    insuranceType: '职工基本医疗保险',
    status: '待审核',
    agency: '苏州',
    submitDate: '2026-04-21',
    basic: {
      gender: '女',
      birthDate: '1993-05-24',
      phone: '13962170028',
      householdAddress: '苏州市姑苏区干将西路210号',
      residenceAddress: '苏州市工业园区东环路89号',
      agency: '苏州',
      employmentForm: '平台接单',
      currentStatus: '正常经营',
    },
  ...
  },
  {
    ...
    basic: {
      ...
      phone: '13852190033',
      householdAddress: '徐州市云龙区和平大道158号',
      residenceAddress: '徐州市泉山区湖北路91号',
      agency: '徐州',
      employerName: '徐州轨道交通运营有限公司',
      creditCode: '91320300MA23XT71XG',
    },
    extra: {
      employmentType: '正式员工',
      joinWorkDate: '2026-03-01',
      paymentBase: '11200',
    },
    photos: {
      profilePhoto: true,
  ...
  },
  {
    ...
    basic: {
      ...
      phone: '13961380026',
      householdAddress: '连云港市海州区解放东路51号',
      residenceAddress: '连云港市海州区学院路88号',
      agency: '连云港',
      schoolName: '连云港市实验学校',
      schoolArea: '海州区',
      studentNo: 'LYGXJ20261206',
    },
    extra: {
      educationStage: '小学',
      className: '六年级2班',
  ...
  },
  {
    ...
    basic: {
      ...
      phone: '13852370045',
      householdAddress: '淮安市清江浦区北京北路178号',
      residenceAddress: '淮安市清江浦区延安西路109号',
      agency: '淮安',
      householdType: '农业户籍',
      community: '清江街道前进社区',
    },
  ...
  },
  {
    ...
    basic: {
      ...
      phone: '13851090062',
      householdAddress: '盐城市亭湖区建军东路66号',
      residenceAddress: '盐城市亭湖区建军东路66号',
      agency: '盐城',
      birthCertNo: 'JS320900202604020045',
      guardianName: '赵雨桐',
      guardianRelation: '母亲',
      guardianPhone: '13851090061',
    },
    extra: {
      fatherName: '赵明远',
      fatherIdCard: '320902199212154513',
      motherName: '赵雨桐',
      motherIdCard: '320902199501083624',
      followInsured: '随母参保',
      settlementStatus: '未落户',
    },
    photos: {
      profilePhoto: true,
      birthCertificate: true,
  ...
  },
  {
    ...
    basic: {
      ...
      phone: '13852580034',
      householdAddress: '扬州市广陵区文昌中路109号',
      residenceAddress: '扬州市邗江区润扬中路16号',
      agency: '扬州',
      veteranCertNo: 'TYJR-YZ-2025-0421',
      retireDate: '2025-04-30',
      serviceType: '义务兵',
    },
    extra: {
      placementType: '政府安置',
      retireBureau: '扬州市退役军人事务局',
      preferentialType: '重点优抚对象',
    },
    photos: {
      profilePhoto: true,
      idCardFront: true,
  ...
  },
  {
    ...
    basic: {
      ...
      phone: '13852930041',
      householdAddress: '镇江市京口区中山东路77号',
      residenceAddress: '镇江市润州区南徐大道120号',
      agency: '镇江',
      employerName: '镇江港务集团有限公司',
      creditCode: '91321100MA1N4F2L7P',
    },
    extra: {
      employmentType: '劳务派遣',
      joinWorkDate: '2025-12-01',
      paymentBase: '8600',
    },
    photos: {
      profilePhoto: true,
  ...
  },
  {
    ...
    basic: {
      ...
      phone: '13852670022',
      householdAddress: '泰州市海陵区凤凰东路35号',
      residenceAddress: '泰州市海陵区梅兰东路88号',
      agency: '泰州',
      householdType: '城镇户籍',
      community: '城东街道春晖社区',
    },
  ...
  },
  {
    ...
    basic: {
      ...
      phone: '13852760055',
      householdAddress: '宿迁市宿城区发展大道66号',
      residenceAddress: '宿迁市宿豫区洪泽湖东路28号',
      agency: '宿迁',
      employmentForm: '个体经营',
      currentStatus: '正常营业',
    },
  ...
  },
  {
    ...
    basic: {
      ...
      phone: '13961230037',
      householdAddress: '常州市新北区龙城大道101号',
      residenceAddress: '常州市新北区太湖东路56号',
      agency: '常州',
      schoolName: '常州市第一中学',
      schoolArea: '新北区',
      studentNo: 'CZXJ20260928',
    },
    extra: {
      educationStage: '高中',
      className: '高一5班',
  ...
  },
  {
    ...
    basic: {
      ...
      phone: '13851880029',
      householdAddress: '连云港市海州区朝阳东路26号',
      residenceAddress: '连云港市海州区学院路133号',
      agency: '连云港',
      employerName: '连云港港口控股集团有限公司',
      creditCode: '91320700MA1W3K8C2D',
    },
    extra: {
      employmentType: '正式员工',
      joinWorkDate: '2026-02-15',
      paymentBase: '10400',
    },
    photos: {
      profilePhoto: true,
  ...
  },
  {
    ...
    basic: {
      ...
      phone: '13862010044',
      householdAddress: '张家港市杨舍镇人民东路219号',
      residenceAddress: '苏州市吴中区东吴北路36号',
      agency: '苏州',
      householdType: '城镇户籍',
      community: '吴中街道东苑社区',
    },
  ...
  },
  {
    ...
    basic: {
      ...
      phone: '13861030073',
      householdAddress: '常州市钟楼区清潭路68号',
      residenceAddress: '常州市钟楼区清潭路68号',
      agency: '常州',
      birthCertNo: 'JS320400202603280024',
      guardianName: '顾若薇',
      guardianRelation: '母亲',
      guardianPhone: '13861030072',
    },
    extra: {
      fatherName: '顾晨峰',
      fatherIdCard: '320411199107154817',
      motherName: '顾若薇',
      motherIdCard: '320411199403186528',
      followInsured: '随父参保',
      settlementStatus: '已落户',
    },
    photos: {
  ...
  },
  {
    ...
    basic: {
      ...
      phone: '13851050067',
      householdAddress: '盐城市射阳县人民路101号',
      residenceAddress: '盐城市亭湖区青年东路98号',
      agency: '盐城',
      veteranCertNo: 'TYJR-YC-2024-1126',
      retireDate: '2024-11-30',
      serviceType: '士官',
    },
    extra: {
      placementType: '自主就业',
      retireBureau: '盐城市退役军人事务局',
      preferentialType: '普通退役军人',
    },
    photos: {
      profilePhoto: true,
  ...
  },
  {
    ...
    basic: {
      ...
      phone: '13814080052',
      householdAddress: '南京市江宁区天元东路188号',
      residenceAddress: '南京市雨花台区软件大道99号',
      agency: '南京',
      employmentForm: '自由职业',
      currentStatus: '正常参保',
    },
  ...
  },
  {
    ...
    basic: {
      ...
      phone: '13861720039',
      householdAddress: '无锡市梁溪区人民中路88号',
      residenceAddress: '无锡市滨湖区金石路28号',
      agency: '无锡',
      employerName: '无锡芯联智造有限公司',
      creditCode: '91320214MA27P5N81J',
    },
    extra: {
      employmentType: '正式员工',
      joinWorkDate: '2026-01-10',
      paymentBase: '11800',
    },
    photos: {
      profilePhoto: true,
  ...
  },
  {
    ...
    basic: {
      ...
      phone: '13952810032',
      householdAddress: '丹阳市开发区迎春路18号',
      residenceAddress: '镇江市丹徒区谷阳大道36号',
      agency: '镇江',
      schoolName: '丹阳市华南实验学校',
      schoolArea: '丹阳市',
      studentNo: 'ZJXJ20261018',
    },
    extra: {
      educationStage: '初中',
      className: '八年级1班',
