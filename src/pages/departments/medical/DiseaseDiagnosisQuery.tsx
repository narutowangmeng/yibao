...
const mockDiseases: Disease[] = [
  ['A41.900', '败血症', '传染病', '细菌感染引起的全身炎症反应综合征。'],
  ['B18.100', '慢性乙型病毒性肝炎', '传染病', '乙肝病毒持续感染导致的慢性肝病。'],
  ['E11.900', '2型糖尿病', '内分泌疾病', '以高血糖为主要特征的代谢性疾病。'],
  ['E78.500', '高脂血症', '内分泌疾病', '血脂水平升高，增加动脉粥样硬化风险。'],
  ['I10.x00', '原发性高血压', '心血管疾病', '无明确继发病因的血压持续升高。'],
  ['I25.100', '冠状动脉粥样硬化性心脏病', '心血管疾病', '冠脉狭窄导致心肌缺血。'],
  ['I50.900', '心力衰竭', '心血管疾病', '心脏泵血功能受损引起循环障碍。'],
  ['C16.900', '胃恶性肿瘤', '恶性肿瘤', '胃部原发恶性肿瘤。'],
  ['C34.900', '肺恶性肿瘤', '恶性肿瘤', '肺部原发恶性肿瘤。'],
  ['C50.900', '乳房恶性肿瘤', '恶性肿瘤', '乳腺组织原发恶性肿瘤。'],
  ['J18.900', '肺炎', '呼吸系统疾病', '由感染等因素引起的肺实质炎症。'],
  ['J44.900', '慢性阻塞性肺疾病', '呼吸系统疾病', '气流受限持续存在并进行性发展。'],
  ['J45.909', '支气管哮喘', '呼吸系统疾病', '慢性气道炎症伴可逆性气流受限。'],
  ['G45.900', '短暂性脑缺血发作', '神经系统疾病', '脑供血短暂不足导致局灶性神经症状。'],
  ['G47.300', '睡眠呼吸暂停综合征', '神经系统疾病', '睡眠中反复出现呼吸暂停和低通气。'],
  ['G40.900', '癫痫', '神经系统疾病', '脑神经元异常放电导致反复发作。'],
