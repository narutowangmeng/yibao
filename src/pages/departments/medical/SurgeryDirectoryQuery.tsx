...
import { Search, Scissors, Plus, Edit2, Trash2, Eye, X } from 'lucide-react';
...
const mockData: SurgeryItem[] = [
  { id: '1', code: 'SUR001', name: '阑尾切除术', category: '腹部手术', level: '二级', price: 3500, status: 'active' },
  { id: '2', code: 'SUR002', name: '胆囊切除术', category: '腹部手术', level: '三级', price: 6800, status: 'active' },
];

const categories = ['全部', '腹部手术', '骨科手术', '眼科手术', '心胸外科'];
...
export default function SurgeryDirectoryQuery() {
  ...
  const [formData, setFormData] = useState({
    code: '', name: '', category: '腹部手术', level: '二级' as const, price: 0
  });
